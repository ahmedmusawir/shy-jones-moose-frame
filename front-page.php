				...
				<div class="col-md-6">
					...
					<article class="right-text">
						...
						<div class="btn-contaienr">
							<a class="btn btn-primary btn-lg btn-block" href="#">CLICK HERE</a>
						</div>
...
<section class="block-3">
	...
	<div class="content-wrapper">
			...
			<div class="block-3-header-container">
				
				<h1 class="block-3-header">
					Listen up Gorgeous, 
				</h1>
...
<section class="block-4">
	...
	<div class="content-wrapper">
	    ...
	    <div class="text-content">
	      ...
	      <h2>Are We a Match Made in Heaven?</h2>
